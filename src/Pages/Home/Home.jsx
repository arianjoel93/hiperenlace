            ...
            <div className="Home">
                <div className="cHeader Container">
                    ...
                    <div className="cSearcher">
                        ...
                        <Dropdown value={selectedType} onChange={(e) => setSelectedType(e.value)} options={types} optionLabel="name" placeholder="Selecciona un sector "
                            filter valueTemplate={selectedCountryTemplate} itemTemplate={countryOptionTemplate} className="w-full md:w-14rem" />
                        <SelectCountry active={active} setSelectedCountry={setSelectedCountry} selectedCountry={selectedCountry} />
